...
int TForm1::GetCredits(String course)
{
...
//---------------------------------------------------------------------------
// ✅ FIXED SUMMER
void TForm1::UpdateSummerCredits()
{
	...
	{
		credit1 = GetCredits(c1);
		credit2 = GetCredits(c2);
	}
	...
	// ✅ FIX
	summerCredits2 = credit1 + credit2;

	summerTotal2 = 0;
	if (credit1 > 0) summerTotal2++;
	if (credit2 > 0) summerTotal2++;

	Label14->Caption = IntToStr(summerTotal2);

	// ✅ FINAL TOTAL
	Label3->Caption = FormatFloat("0.0", normalCredits + summerCredits2);
}
...
// ✅ FIXED
bool TForm1::IsRealSelection(TComboBox* cb)
{
...
int TForm1::GetSemesterCredit(String course)
{
	if (course == "" || course.Pos("Optional"))
		return 0;
...
double TForm1::GetAPCredit(String course)
{
	if (course.Pos("AP"))
		return 1.5;
	if (course == "" || course.Pos("Optional"))
...
//---------------------------------------------------------------------------
// ✅ FIXED NORMAL CREDITS
void TForm1::UpdateAllCredits()
{
	...
	normalCredits += credit9 + credit10 + credit11;

	// -------- Regular classes --------
	int c17 = IsRealSelection(ComboBox17) ? 1 : 0;
	int c18 = IsRealSelection(ComboBox18) ? 1 : 0;
	int c26 = IsRealSelection(ComboBox26) ? 1 : 0;
	...
	Label37->Caption = IntToStr(c16);
	Label39->Caption = IntToStr(c13);
	Label41->Caption = IntToStr(c14);
	Label32->Caption = IntToStr(c26);

	normalCredits += c17 + c18 + c16 + c13 + c14 + c26;
...
void __fastcall TForm1::ComboBox5Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox6Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox7Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox8Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox21Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox17Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox18Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox19Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox9Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox22Change(TObject *Sender){ UpdateAllCredits(); }
void __fastcall TForm1::ComboBox26Change(TObject *Sender){ UpdateAllCredits(); }
...
void __fastcall TForm1::ComboBox3Change(TObject *Sender)
{
	...
	{
		String arr[5] = {"Spanish","Chinese","Latin","French","German"};
		for(int i = 0; i < 5; i++) ComboBox10->Items->Add(arr[i]);
	}
	else if (ComboBox3->Text == "Business")
	{
		String arr[3] = {"Business 1","Business 2","Business Technology"};
		for(int i = 0; i < 3; i++) ComboBox10->Items->Add(arr[i]);
	}
	else if (ComboBox3->Text == "Computer Science")
	{
		String arr[2] = {"Computer Programming 1","AP Computer Programming"};
		for(int i = 0; i < 2; i++) ComboBox10->Items->Add(arr[i]);
	}
	else if (ComboBox3->Text == "Music")
	{
		String arr[4] = {"Band","Orchestra","Piano","Guitar"};
		for(int i = 0; i < 4; i++) ComboBox10->Items->Add(arr[i]);
	}
...
void __fastcall TForm1::ComboBox4Change(TObject *Sender)
{
	...
	{
		String arr[5] = {"Spanish","Chinese","Latin","French","German"};
		for(int i = 0; i < 5; i++) ComboBox11->Items->Add(arr[i]);
	}
	else if (ComboBox4->Text == "Business")
	{
		String arr[3] = {"Business 1","Business 2","Business Technology"};
		for(int i = 0; i < 3; i++) ComboBox11->Items->Add(arr[i]);
	}
	else if (ComboBox4->Text == "Computer Science")
	{
		String arr[2] = {"Computer Programming 1","AP Computer Programming"};
		for(int i = 0; i < 2; i++) ComboBox11->Items->Add(arr[i]);
	}
	else if (ComboBox4->Text == "Music")
	{
		String arr[4] = {"Band","Orchestra","Piano","Guitar"};
		for(int i = 0; i < 4; i++) ComboBox11->Items->Add(arr[i]);
	}
...
void __fastcall TForm1::ComboBox16Change(TObject *Sender)
{
	...
	{
		String arr[5] = {"Spanish","Chinese","Latin","French","German"};
		for(int i = 0; i < 5; i++) ComboBox23->Items->Add(arr[i]);
	}
	else if (ComboBox16->Text == "Business")
	{
		String arr[3] = {"Business 1","Business 2","Business Technology"};
		for(int i = 0; i < 3; i++) ComboBox23->Items->Add(arr[i]);
	}
	else if (ComboBox16->Text == "Computer Science")
	{
		String arr[2] = {"Computer Programming 1","AP Computer Programming"};
		for(int i = 0; i < 2; i++) ComboBox23->Items->Add(arr[i]);
	}
	else if (ComboBox16->Text == "Music")
	{
		String arr[4] = {"Band","Orchestra","Piano","Guitar"};
		for(int i = 0; i < 4; i++) ComboBox23->Items->Add(arr[i]);
	}
...
void __fastcall TForm1::ComboBox13Change(TObject *Sender)
{
	...
	{
		String arr[5] = {"Spanish","Chinese","Latin","French","German"};
		for(int i = 0; i < 5; i++) ComboBox24->Items->Add(arr[i]);
	}
	else if (ComboBox13->Text == "Business")
	{
		String arr[3] = {"Business 1","Business 2","Business Technology"};
		for(int i = 0; i < 3; i++) ComboBox24->Items->Add(arr[i]);
	}
	else if (ComboBox13->Text == "Computer Science")
	{
		String arr[2] = {"Computer Programming 1","AP Computer Programming"};
		for(int i = 0; i < 2; i++) ComboBox24->Items->Add(arr[i]);
	}
	else if (ComboBox13->Text == "Music")
	{
		String arr[4] = {"Band","Orchestra","Piano","Guitar"};
		for(int i = 0; i < 4; i++) ComboBox24->Items->Add(arr[i]);
	}
...
void __fastcall TForm1::ComboBox14Change(TObject *Sender)
{
	...
	{
		String arr[5] = {"Spanish","Chinese","Latin","French","German"};
		for(int i = 0; i < 5; i++) ComboBox25->Items->Add(arr[i]);
	}
	else if (ComboBox14->Text == "Business")
	{
		String arr[3] = {"Business 1","Business 2","Business Technology"};
		for(int i = 0; i < 3; i++) ComboBox25->Items->Add(arr[i]);
	}
	else if (ComboBox14->Text == "Computer Science")
	{
		String arr[2] = {"Computer Programming 1","AP Computer Programming"};
		for(int i = 0; i < 2; i++) ComboBox25->Items->Add(arr[i]);
	}
	else if (ComboBox14->Text == "Music")
	{
		String arr[4] = {"Band","Orchestra","Piano","Guitar"};
		for(int i = 0; i < 4; i++) ComboBox25->Items->Add(arr[i]);
	}
