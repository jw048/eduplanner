...
Label3->Caption  = IntToStr(totalCredits2);
}
...
void TForm1::UpdateAllCredits()
{
    ...
    totalCredits2 += credit22 + credit5 + credit6;
	...
	totalCredits2 += credit7 + credit8; // ? FIXED (removed credit22)
    ...
    totalCredits2 += credit9 + credit10 + credit11;
    ...
    totalCredits2 += c17 + c18 + c16 + c13 + c14 + c26;
    ...
    totalCredits2 += c19 + c20;

    // -------- TOTAL --------
    Label3->Caption = FormatFloat("0.0", totalCredits2);
